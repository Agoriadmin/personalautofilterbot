    ...
    if len(results) == 0: # double check
        ...
        try:
           await bot.send_message(
                ...
                caption=f"<b>Group:-<b>@agorimovies</b> \nRequested Movie:-{query} \nResults Found:-{(len_results)} \nRequested User:-{update.from_user.mention} \n\nPress the Down Bottons To Access The File\n\nപടം ലഭിക്കുന്നതിനായി ഇവിടെ ക്ലിക്ക് ചെയ്താൽ കിട്ടുന്ന ചാനലിൽ ജോയിൻ ആയ ശേഷം താഴെ കാണുന്ന ബട്ടണുകളിൽ ക്ലിക്ക് ചെയ്യുക👇</b>",
